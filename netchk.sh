...
#Description: Runs some rudamentary checks on your network connectivity and return some useful information for troubleshooting network issues. It return the following information:
