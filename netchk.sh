...
#Description: Runs some rudimentary checks on your network connectivity and returns some useful information for troubleshooting network issues. It returns the following information:
